...
import { Play, WifiOff, Globe2, Music, BookOpen, Layers, Terminal, Video } from 'lucide-react';
      ...
      <nav className="fixed top-0 w-full z-50 glass border-b border-stone-800 backdrop-blur-md bg-stone-950/50">
        <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
          <div className="flex items-center gap-2">
            <Image src="/logo.png" alt="Omlila Logo" width={36} height={36} className="rounded-full overflow-hidden shadow-md shadow-moss-400/20" />
      ...
      <section id="products" className="py-32 relative bg-stone-950">
        <div className="max-w-7xl mx-auto px-6">
          <div className="mb-20">
            ...
            <p className="text-xl text-stone-400 max-w-2xl">High-performance applications built to run autonomously on client devices, giving everyone the full power of AI and media creation.</p>
          </div>

          <div className="grid md:grid-cols-2 gap-8">
            {/* Product 0: Video Studio */}
            <div className="p-10 rounded-3xl bg-stone-900 border border-moss-500/30 hover:border-moss-500/60 transition-all group relative overflow-hidden md:col-span-2">
              <div className="absolute top-0 right-0 p-8 opacity-10 group-hover:opacity-20 transition-opacity">
                <Video className="w-48 h-48 text-moss-400" />
              </div>
              <div className="relative z-10 max-w-3xl">
                ...
                <div className="w-16 h-16 rounded-2xl bg-moss-500/10 flex items-center justify-center mb-8 border border-moss-500/20">
                  <Video className="w-8 h-8 text-moss-400" />
                </div>
                <h3 className="text-3xl font-bold text-white mb-4">Omlila Lyrical Video Studio</h3>
                <p className="text-stone-300 text-lg mb-8 leading-relaxed">
                  A client-side 4K typography video generator running completely inside your browser. Synchronize audio, custom LRC lyrics, dynamic canvas visuals, and export smooth MP4 videos without requiring any server compute.
                </p>
                <div className="grid sm:grid-cols-3 gap-4 mb-8">
                  <div className="flex items-center gap-2 text-stone-300 text-sm">
                    <div className="w-2 h-2 rounded-full bg-moss-500" />
                    <span>Browser-Native 4K MP4 Muxing</span>
                  </div>
                  <div className="flex items-center gap-2 text-stone-300 text-sm">
                    <div className="w-2 h-2 rounded-full bg-moss-500" />
                    <span>Real-time Audio Beat Sync</span>
                  </div>
                  <div className="flex items-center gap-2 text-stone-300 text-sm">
                    <div className="w-2 h-2 rounded-full bg-moss-500" />
                    <span>Multi-Ratio (9:16, 16:9, 1:1)</span>
                  </div>
                </div>
                <Link
                  href="/studio/"
